...
const apiRoutesMovement = require("./backend/routes/api_movement")(
  app,
  express
);
const apiRoutesSet = require("./backend/routes/api_set")(app, express);
const apiRoutesExercise = require("./backend/routes/api_exercise")(
  app,
  express
);
...
let server = app.listen(config.port, () => {
  console.log(
    `Express server ${ip.address()} listening on port ${config.port}`
  );
});
